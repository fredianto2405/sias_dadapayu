          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="tanggal_surat" id="tanggal_surat" class="form-control datepicker" placeholder="Masukkan tanggal surat" value="<?php echo date('m/d/Y'); ?>" required>
              </div>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="edit_tanggal_surat" id="edit_tanggal_surat" class="form-control datepicker" placeholder="Masukkan tanggal surat" required>
              </div>
            </div>
          </div>
          <div class="form-group">
