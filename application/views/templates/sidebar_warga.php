  ...
  <div class="scrollbar-inner">
    ...
    <div class="navbar-inner">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link <?php echo $uri == 'beranda' ? 'active' : ''; ?>" href="<?php echo base_url('warga/beranda'); ?>">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link <?php echo $uri == 'pengajuan-surat' ? 'active' : ''; ?>" href="<?php echo base_url('warga/pengajuan-surat'); ?>">
        ...
        <ul class="navbar-nav align-items-center  ml-md-auto ">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-xl  dropdown-menu-right  py-0 overflow-hidden">
              ...
              <!-- View all -->
              <a href="<?php echo base_url('warga/pengajuan-surat'); ?>" class="dropdown-item text-center text-primary font-weight-bold py-3">Lihat semua</a>
            </div>
          </li>
        </ul>
        <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu  dropdown-menu-right ">
              <a href="<?php echo base_url('warga/profil-saya'); ?>" class="dropdown-item">
                <i class="ni ni-single-02"></i>
                <span>Profil Saya</span>
              </a>
              <a href="<?php echo base_url('warga/ubah-kata-sandi') ?>" class="dropdown-item">
