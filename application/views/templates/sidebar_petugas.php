        ...
        <ul class="navbar-nav align-items-center  ml-md-auto ">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-xl  dropdown-menu-right  py-0 overflow-hidden">
              ...
              <!-- View all -->
              <a href="<?php echo base_url('petugas/pengajuan-surat'); ?>" class="dropdown-item text-center text-primary font-weight-bold py-3">Lihat semua</a>
            </div>
          </li>
        </ul>
        <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu  dropdown-menu-right ">
              <a href="<?php echo base_url('petugas/profil-saya'); ?>" class="dropdown-item">
                <i class="ni ni-single-02"></i>
                <span>Profil Saya</span>
              </a>
              <a href="<?php echo base_url('petugas/ubah-kata-sandi') ?>" class="dropdown-item">
