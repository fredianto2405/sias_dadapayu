...
$html = '
    ...
    <table cellpadding="10">
      <tr align="center">
        <td>
          <span style="font-size: 14px;"><b>SURAT PENGANTAR AKTA KELAHIRAN</b></span> <br>
    ...
    <table>
      <tr>
        ...
        <td width="20%">Nama</td>
        <td width="3%">:</td>
        <td width="57%">' . $data->nama_orang_tua . '</td>
        <td width="7%"></td>
      </tr>
      <tr>
        <td width="13%"></td>
    ...
    <table cellpadding="10">
      <tr>
        <td width="5%"></td>
        <td width="90%">Orang tersebut akan mencarikan AKTA KELAHIRAN atas anaknya Ke Kantor Catatan Sipil Kabupaten Gunungkidul</td>
        <td width="5%"></td>
      </tr>
    </table>
    ...
    <table>
      <tr>
        ...
        <td width="20%">Nama</td>
        <td width="3%">:</td>
        <td width="57%">' . $data->nama_anak . '</td>
        <td width="7%"></td>
      </tr>
      <tr>
        <td width="13%"></td>
        <td width="20%">Hari Lahir</td>
        <td width="3%">:</td>
        <td width="57%">' . $data->hari_lahir . '</td>
        <td width="7%"></td>
      </tr>
      <tr>
        <td width="13%"></td>
    ...
    <table cellpadding="10">
      <tr>
        <td width="5%"></td>
        <td width="90%">Demikian surat Pengantar ini kami buat dengan sebenarnya agar dapat dipergunakan sebagaimana mestinya.</td>
        <td width="5%"></td>
      </tr>
    </table>
